...
library(haven)
UNHCR_SSD_2023_FDS_data_main <- read_dta("Datathon data/Forced Displacement Survey - S Sudan/data/UNHCR_SSD_2023_FDS_data_v2/UNHCR_SSD_2023_FDS_data_main.dta")
#View(UNHCR_SSD_2023_FDS_data_main)
library(haven)
UNHCR_SSD_2023_FDS_data_member <- read_dta("Datathon data/Forced Displacement Survey - S Sudan/data/UNHCR_SSD_2023_FDS_data_v2/UNHCR_SSD_2023_FDS_data_member.dta")

UNHCR_SSD_2023_FDS_data_caregiver <- read_dta("Datathon data/Forced Displacement Survey - S Sudan/data/UNHCR_SSD_2023_FDS_data_v2/UNHCR_SSD_2023_FDS_data_caregiver.dta")
#View(UNHCR_SSD_2023_FDS_data_member)

UNHCR_SSD_2023_FDS_data_woman <- read_dta("Datathon data/Forced Displacement Survey - S Sudan/data/UNHCR_SSD_2023_FDS_data_v2/UNHCR_SSD_2023_FDS_data_woman.dta")

UNHCR_SSD_2023_FDS_data_roster <- read_dta("Datathon data/Forced Displacement Survey - S Sudan/data/UNHCR_SSD_2023_FDS_data_v2/UNHCR_SSD_2023_FDS_data_roster.dta")
...
data <- data %>% mutate(rCSI = as.numeric(rCSILessQlty) + 
                              (as.numeric(rCSIBorrow * 2)) + 
                               as.numeric(rCSIMealNb) + 
                               as.numeric(rCSIMealSize) + 
                              (as.numeric(rCSIMealAdult * 3)))
